...
class CustomResourceResponse implements Responsable
{
     ...
     * @return array
     */
    protected function wrap($message, $data, $with = [], $additional = [])
    {
        ...
        return array_merge_recursive($message, $data, $with, $additional);
    }
